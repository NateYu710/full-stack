...
const inputPrice2 = Number(inputPrice);
const inputDeliveryFee2 = Number(inputDeliveryFee);

const TotalAmount = inputPrice2 + inputDeliveryFee2;
console.log(`총 결제 금액: ${TotalAmount}`);
console.log(`합계 타입 ${typeof(TotalAmount)}`);
...
const canGetGreeDelivery = (orderAmount >= 20000 && isMember == true);
console.log(canGetGreeDelivery);
...
getOrderTotal(3000, 2);
getOrderTotal(5000, 1);
getOrderTotal(3000, 0);
getOrderTotal(3000, -2);
